...
chickendinner Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as chickendinner Core, where everyone uses
...
pay attention to for reviewers of chickendinner Core code.

General chickendinner Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: chickendinner Core uses tinyformat, which is type safe. Leave them out to avoid confusion
