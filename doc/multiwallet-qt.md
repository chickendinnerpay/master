...
Only requiring some minor changes is chickendinner.cpp.
...
Changes to chickendinner.cpp
----------------------
chickendinner.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
