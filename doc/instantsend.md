...
This mechanism has been integrated into Bitcore-Node-chickendinner which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/chickendinnerpay/insight-api-chickendinner#web-socket-api](https://github.com/chickendinnerpay/insight-api-chickendinner#web-socket-api)
* API: [https://github.com/chickendinnerpay/insight-api-chickendinner#instantsend-transactions](https://github.com/chickendinnerpay/insight-api-chickendinner#instantsend-transactions)
...
By default, the chickendinner Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the chickendinner Core daemon:
