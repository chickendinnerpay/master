...
2. run chickendinnerd with -printalert or -sendalert like this:
   /path/to/chickendinnerd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.chickendinner.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/chickendinner Core:0.12.0.58/"));
