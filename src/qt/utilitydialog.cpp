    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("chickendinner Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About chickendinner Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  chickendinner-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the chickendinner in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 chickendinner, 0.1 chickendinner, 1 chickendinner and 10 chickendinner -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://chickendinnerpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://chickendinnerpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("chickendinner Core is shutting down...") + "<br /><br />" +
