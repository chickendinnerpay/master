    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("chickendinner Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a chickendinner address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chickendinner: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About chickendinner Core"), this);
    aboutAction->setStatusTip(tr("Show information about chickendinner Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for chickendinner Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your chickendinner addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified chickendinner addresses"));
    ...
    openAction->setStatusTip(tr("Open a chickendinner: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the chickendinner Core help message to get a list with possible chickendinner Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("chickendinner Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to chickendinner network", "", count));
    } else {
...
{
    QString strTitle = tr("chickendinner Core"); // default title
    ...
    // Append title to "chickendinner Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
