    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("chickendinner-light"), QVariant("light"));
    ui->theme->addItem(QString("chickendinner-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("chickendinner-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("chickendinner-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("chickendinner-traditional"), QVariant("trad"));
