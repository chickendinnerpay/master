...
#define BOOST_TEST_MODULE chickendinner Test Suite

#include "test_chickendinner.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_chickendinner_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
