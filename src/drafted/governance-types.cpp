...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "chickendinnerNetwork") type = chickendinnerNetwork;
    if(strType == "chickendinnerNetworkVariable") type = chickendinnerNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == chickendinnerNetwork) s = "chickendinnerNetwork";
    if(type == chickendinnerNetworkVariable) s = "chickendinnerNetworkVariable";
