...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("chickendinner Core chickendinner-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  chickendinner-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chickendinner transaction") + "\n" +
              "  chickendinner-tx [options] -create [commands]   " + _("Create hex-encoded chickendinner transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chickendinner transaction
